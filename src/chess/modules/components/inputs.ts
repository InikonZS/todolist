...
class Input extends Control {
  ...
  constructor(parentNode: HTMLElement, caption: string, onValidate: (param: string) => Promise<string | null>, placeHolder = '', type: string, id = 'input') {
  ...
  getValue() {
    const inputValue = (this.field.node as HTMLInputElement).value;
    return inputValue;
  }
