...
export class AuthForm extends Control {
  ...
  constructor(parentNode:HTMLElement){
    ...
    this.nameInput = new Input(this.field,'Name',(param)=>{return  null },'enter your name','text');
    this.passwordInput = new Input(this.field,'Password',(param)=>{return  null },'enter your password','text');
